...
pub async fn execute_page_press(params: PagePressParams) -> WasmAsyncResponse {
    ...
    let target: web_sys::EventTarget = {
        let ref_id = optional_str(&params.ref_id);
        if !ref_id.is_empty() {
    ...
    if let Some(select) = element.dyn_ref::<web_sys::HtmlSelectElement>() {
        ...
        if select.multiple() && values.len() > 1 {
            ...
            for i in 0..select.length() {
                if let Some(opt_el) = select.item(i) {
                    if let Some(opt) = opt_el.dyn_ref::<web_sys::HtmlOptionElement>() {
                        _ = opt.set_selected(wanted.contains(&opt.value()));
                    }
                }
            }
        } else {
            select.set_value(values.first().map(|v| v.as_str()).unwrap_or(""));
        }
    }
    WasmAsyncResponse {
        ok: true,
...
pub fn init_registry() {
    ...
    web_js_core::web_api! {
        ...
        namespace: "fs",
        name: "stat",
        doc: "Get file or directory metadata. Paths may be absolute or relative (relative resolves against root).",
        params: [
            path: "string", "required", "Absolute or relative path (relative resolves against root)",
        ],
    ...
    web_js_core::web_api! {
        ...
        namespace: "fs",
        name: "list",
        doc: "List directory contents. Paths may be absolute or relative (relative resolves against root).",
        params: [
    ...
    web_js_core::web_api! {
        ...
        namespace: "fs",
        name: "move",
        doc: "Move or rename a file. Destination auto-creates parent directories. Paths may be absolute or relative (relative resolves against root).",
        params: [
            from: "string", "required", "Source path (absolute or relative; relative resolves against root)",
            to: "string", "required", "Destination path (absolute or relative; relative resolves against root)",
        ],
    ...
    web_js_core::web_api! {
        ...
        namespace: "fs",
        name: "read",
        doc: "Read a file as base64. Returns E_NOT_FOUND if the file does not exist. Paths may be absolute or relative (relative resolves against root).",
        params: [
    ...
    web_js_core::web_api! {
        ...
        namespace: "fs",
        name: "readText",
        doc: "Read a file as text. Returns E_NOT_FOUND if the file does not exist. Paths may be absolute or relative (relative resolves against root).",
        params: [
            path: "string", "required", "Absolute or relative file path (relative resolves against root)",
        ],
    ...
    web_js_core::web_api! {
        ...
        namespace: "fs",
        name: "readRange",
        doc: "Read a range of bytes from a file. Returns E_NOT_FOUND if the file does not exist. Paths may be absolute or relative (relative resolves against root).",
        params: [
            path: "string", "required", "Absolute or relative file path (relative resolves against root)",
    ...
    web_js_core::web_api! {
        ...
        namespace: "fs",
        name: "write",
        doc: "Write base64 data to a file. Auto-creates the file and any missing parent directories; overwrites if exists. Paths may be absolute or relative (relative resolves against root).",
        params: [
            path: "string", "required", "Absolute or relative file path (relative resolves against root)",
    ...
    web_js_core::web_api! {
        ...
        namespace: "fs",
        name: "writeText",
        doc: "Write text to a file. Auto-creates the file and any missing parent directories; overwrites if exists. Paths may be absolute or relative (relative resolves against root).",
        params: [
            path: "string", "required", "Absolute or relative file path (relative resolves against root)",
    ...
    web_js_core::web_api! {
        ...
        namespace: "fs",
        name: "append",
        doc: "Append base64 data to a file. Auto-creates the file and any missing parent directories if missing. Paths may be absolute or relative (relative resolves against root).",
        params: [
            path: "string", "required", "Absolute or relative file path (relative resolves against root)",
            data: "string", "required", "Base64-encoded data",
        ],
    ...
    web_js_core::web_api! {
        ...
        namespace: "fs",
        name: "appendText",
        doc: "Append text to a file. Auto-creates the file and any missing parent directories if missing. Paths may be absolute or relative (relative resolves against root).",
        params: [
            path: "string", "required", "Absolute or relative file path (relative resolves against root)",
            data: "string", "required", "Text data",
        ],
    ...
    web_js_core::web_api! {
        ...
        namespace: "fs",
        name: "update",
        doc: "Update a file at a given offset (existing file only). Returns E_NOT_FOUND if the file does not exist. Paths may be absolute or relative (relative resolves against root).",
        params: [
            path: "string", "required", "Absolute or relative file path (relative resolves against root)",
            offset: "number", "required", "Start offset",
            data: "string", "required", "Base64-encoded data",
