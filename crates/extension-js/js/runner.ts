...
export { setRunnerAbortController } from "./tool-registry.js";
export { type Command } from "./tool-registry.js";
...
export async function executeMainThreadCommand(
	...
	const normalized = normalizeParams(command.action, command.params);
	return dispatchTool(command.action, normalized);
}
...
function registerAlias(
	...
	registerTool({
		...
		returns: returnsSchema,
		handler: async (params) => unwrapResult(await dispatchTool(target, params)),
		paramTypes,
