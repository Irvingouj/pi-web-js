...
macro_rules! impl_extension_session_fs {
    () => {
        ...
        impl ExtensionSession {
            ...
            ) -> Result<$crate::fs::FsExistsResult, String> {
            ...
            pub async fn fs_stat(
                &self,
                params: $crate::fs::FsPathParams,
            ) -> Result<$crate::fs::FsStatResult, String> {
                let meta = web_fs::stat(&params.path)
                    .await
            ...
            pub async fn fs_list(
                &self,
                params: $crate::fs::FsPathParams,
            ) -> Result<$crate::fs::FsListResult, String> {
                let entries = web_fs::list(&params.path)
                    .await
                    .map_err(|e| e.wire_message())?;
                Ok($crate::fs::FsListResult {
                    entries: entries
                        .into_iter()
                        .map(|e| $crate::fs::FsListEntry {
                            name: e.name,
                            kind: match e.kind {
                                web_fs::EntryKind::File => "file".to_string(),
                                web_fs::EntryKind::Directory => "directory".to_string(),
            ...
            pub async fn fs_read(
                ...
                let bytes = web_fs::read(&params.path)
                    .await
                    .map_err(|e| e.wire_message())?;
            ...
            pub async fn fs_read_text(
                ...
                let text = web_fs::read_text(&params.path)
                    .await
                    .map_err(|e| e.wire_message())?;
            ...
            pub async fn fs_read_base64(
                ...
                let b64 = web_fs::read_base64(&params.path)
                    .await
                    .map_err(|e| e.wire_message())?;
            ...
            pub async fn fs_copy(
                &self,
                params: $crate::fs::FsCopyParams,
            ) -> Result<$crate::fs::FsBoolResult, String> {
                web_fs::copy(&params.from, &params.to)
                    .await
                    .map_err(|e| e.wire_message())?;
                Ok($crate::fs::FsBoolResult { ok: true })
            }
            ...
            pub async fn fs_move(
                ...
                web_fs::rename(&params.from, &params.to)
                    .await
                    .map_err(|e| e.wire_message())?;
                Ok($crate::fs::FsBoolResult { ok: true })
            }
            ...
            pub async fn fs_read_range(
                &self,
                params: $crate::fs::FsReadRangeParams,
            ) -> Result<$crate::fs::FsStringResult, String> {
                let len = params.len as usize;
                let bytes = web_fs::read_range(&params.path, params.offset, len)
                    .await
                    .map_err(|e| e.wire_message())?;
                Ok($crate::fs::FsStringResult {
                    data: data_encoding::BASE64.encode(&bytes),
            ...
            pub async fn fs_update(
                &self,
                params: $crate::fs::FsReadRangeDataParams,
            ) -> Result<$crate::fs::FsBoolResult, String> {
                let bytes = data_encoding::BASE64
                    .decode(params.data.as_bytes())
                    .map_err(|_| "Invalid base64".to_string())?;
                web_fs::update(&params.path, params.offset, &bytes)
                    .await
                    .map_err(|e| e.wire_message())?;
                Ok($crate::fs::FsBoolResult { ok: true })
            }
            ...
            pub async fn fs_hash(
                &self,
                params: $crate::fs::FsHashParams,
            ) -> Result<$crate::fs::FsHashResult, String> {
                let hash = web_fs::hash(&params.path, &params.algo)
                    .await
                    .map_err(|e| e.wire_message())?;
