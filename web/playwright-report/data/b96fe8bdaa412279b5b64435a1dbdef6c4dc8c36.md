...
- Name: page-agent.spec.ts >> page.agent >> 27: sidepanel.check on checkbox succeeds
- Location: tests/e2e/page-agent.spec.ts:448:3
        ...
        - generic [ref=e41]:
          ...
          - generic [ref=e44]:
            ...
            - textbox [ref=e67]:
              ...
              - generic [ref=e77]: await sidepanel.check(checkRef, true);
