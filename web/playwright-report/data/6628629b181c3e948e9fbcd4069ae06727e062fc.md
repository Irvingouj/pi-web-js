...
- Name: page-interactions.spec.ts >> page interactions >> 7: page.check on checkbox succeeds
- Location: tests/e2e/page-interactions.spec.ts:178:3
        ...
        - generic [ref=e41]:
          ...
          - generic [ref=e44]:
            ...
            - textbox [ref=e67]:
              ...
              - generic [ref=e69]: let checkRef = null;
              - generic [ref=e70]: "for (const node of snap.data.nodes) {"
              - generic [ref=e71]: "if (node.role === \"checkbox\") {"
              - generic [ref=e72]: checkRef = node.refId;
              - generic [ref=e73]: break;
              - generic [ref=e74]: "}"
              - generic [ref=e75]: "}"
              - generic [ref=e76]: "if (checkRef) {"
              - generic [ref=e77]: await page.check(checkRef, true);
              - generic [ref=e78]: print("checked");
              - generic [ref=e79]: "} else {"
              - generic [ref=e80]: print("no checkbox");
              - generic [ref=e81]: "}"
