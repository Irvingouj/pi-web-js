...
- Name: page-agent.spec.ts >> page.agent >> 26: sidepanel.select on dropdown succeeds
- Location: tests/e2e/page-agent.spec.ts:424:3
          ...
          - generic [ref=e44]:
            - generic [ref=e45]:
              ...
              - generic [ref=e61]:
                ...
                - generic [ref=e65]: ⌄
            - textbox [ref=e67]:
              - generic [ref=e68]: const snap = await sidepanel.snapshot_data();
              ...
              - generic [ref=e77]: await sidepanel.select(selectRef, "b");
