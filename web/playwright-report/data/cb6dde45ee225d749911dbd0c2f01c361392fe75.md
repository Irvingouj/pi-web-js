...
- Name: page-agent.spec.ts >> page.agent >> 21: sidepanel.click on valid ref succeeds
- Location: tests/e2e/page-agent.spec.ts:302:3
          ...
          - generic [ref=e44]:
            - generic [ref=e45]:
              ...
              - generic [ref=e61]:
                ...
                - generic [ref=e65]: ⌄
            - textbox [ref=e67]:
              - generic [ref=e68]: "const snap = await sidepanel.snapshot_data({ interactive_only: true });"
              ...
              - generic [ref=e77]: await sidepanel.click(btnRef);
