...
- Name: fetch.spec.ts >> fetch >> 5: multiple fetch calls in one cell
- Location: tests/e2e/fetch.spec.ts:85:3
        ...
        - generic [ref=e44]:
          - generic [ref=e45]:
            ...
            - generic [ref=e59]:
              ...
              - generic [ref=e63]: ⌄
          - textbox [ref=e65]:
            - generic [ref=e66]: const urls = [
            - generic [ref=e67]: "\"https://httpbin.org/get\","
            - generic [ref=e68]: "\"https://httpbin.org/ip\""
            - generic [ref=e69]: "];"
            - generic [ref=e70]: "for (let i = 0; i < urls.length; i++) {"
            - generic [ref=e71]: "try {"
            - generic [ref=e72]: const result = await fetch(urls[i]);
            - generic [ref=e73]: "print(\"Fetch \" + i + \": \" + result.status);"
            - generic [ref=e74]: "} catch (e) {"
            - generic [ref=e75]: print("Fetch " + i + " error");
            - generic [ref=e76]: "}"
            - generic [ref=e77]: "}"
      - generic [ref=e79]: "Internal error: No pending async command to resume"
  - contentinfo [ref=e80]:
    - text: Powered by
    - link "boa" [ref=e81] [cursor=pointer]:
      - /url: https://github.com/boa-dev/boa
    - text: ·
    - link "JavaScript" [ref=e82] [cursor=pointer]:
      - /url: https://developer.mozilla.org/en-US/docs/Web/JavaScript
    - text: ·
    - link "📚 Showcase" [ref=e83] [cursor=pointer]:
      - /url: "?showcase=true"
```
