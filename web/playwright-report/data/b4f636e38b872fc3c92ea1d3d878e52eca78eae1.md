...
- generic [ref=e2]:
  ...
  - main [ref=e25]:
    - generic [ref=e27]:
      ...
      - generic [ref=e74]:
        - generic [ref=e75]: "ok: true"
        - generic [ref=e76]: "txt: [object Promise]"
  - contentinfo [ref=e77]:
    - text: Powered by
    - link "boa" [ref=e78] [cursor=pointer]:
      - /url: https://github.com/boa-dev/boa
    - text: ·
    - link "JavaScript" [ref=e79] [cursor=pointer]:
      - /url: https://developer.mozilla.org/en-US/docs/Web/JavaScript
    - text: ·
    - link "📚 Showcase" [ref=e80] [cursor=pointer]:
      - /url: "?showcase=true"
```
