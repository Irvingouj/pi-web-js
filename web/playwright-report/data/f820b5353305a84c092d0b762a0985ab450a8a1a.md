...
- Name: page-interactions.spec.ts >> page interactions >> 6: page.select on dropdown succeeds
- Location: tests/e2e/page-interactions.spec.ts:154:3
          ...
          - generic [ref=e44]:
            - generic [ref=e45]:
              ...
              - generic [ref=e61]:
                ...
                - generic [ref=e65]: ⌄
            - textbox [ref=e67]:
              - generic [ref=e68]: const snap = await page.snapshot_data();
              - generic [ref=e69]: let selectRef = null;
              - generic [ref=e70]: "for (const node of snap.data.nodes) {"
              - generic [ref=e71]: "if (node.tag === \"select\" || node.role === \"combobox\") {"
              - generic [ref=e72]: selectRef = node.refId;
              - generic [ref=e73]: break;
              - generic [ref=e74]: "}"
              - generic [ref=e75]: "}"
              - generic [ref=e76]: "if (selectRef) {"
              - generic [ref=e77]: await page.select(selectRef, "b");
              - generic [ref=e78]: print("selected");
              - generic [ref=e79]: "} else {"
              - generic [ref=e80]: print("no select");
              - generic [ref=e81]: "}"
