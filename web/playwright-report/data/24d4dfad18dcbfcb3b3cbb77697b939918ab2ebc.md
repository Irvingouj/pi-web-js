...
- Name: page-interactions.spec.ts >> page interactions >> 1: page.click on valid ref succeeds
- Location: tests/e2e/page-interactions.spec.ts:33:3
          ...
          - generic [ref=e44]:
            - generic [ref=e45]:
              ...
              - generic [ref=e61]:
                ...
                - generic [ref=e65]: ⌄
            - textbox [ref=e67]:
              - generic [ref=e68]: "const snap = await page.snapshot_data({ interactive_only: true });"
              - generic [ref=e69]: let btnRef = null;
              - generic [ref=e70]: "for (const node of snap.data.nodes) {"
              - generic [ref=e71]: "if (node.role === \"button\") {"
              - generic [ref=e72]: btnRef = node.refId;
              - generic [ref=e73]: break;
              - generic [ref=e74]: "}"
              - generic [ref=e75]: "}"
              - generic [ref=e76]: "if (btnRef) {"
              - generic [ref=e77]: await page.click(btnRef);
              - generic [ref=e78]: print("clicked");
              - generic [ref=e79]: "} else {"
              - generic [ref=e80]: print("no button");
              - generic [ref=e81]: "}"
        - generic [ref=e83]: "Internal error: No pending async command to resume"
    - contentinfo [ref=e84]:
      - text: Powered by
      ...
      - link "📚 Showcase" [ref=e87] [cursor=pointer]:
        - /url: "?showcase=true"
  - generic [ref=e88]:
    - textbox [ref=e89]: initial
    - combobox [ref=e90]:
      - option "Option A" [selected]
      - option "Option B"
    - checkbox [ref=e91]
    - button "Click me" [ref=e92]
```
