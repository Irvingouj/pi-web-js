...
- generic [ref=e2]:
  ...
  - main [ref=e25]:
    - generic [ref=e27]:
      ...
      - generic [ref=e61]: "Internal error: No pending async command to resume"
  - contentinfo [ref=e62]:
    - text: Powered by
    - link "boa" [ref=e63] [cursor=pointer]:
      - /url: https://github.com/boa-dev/boa
    - text: ·
    - link "JavaScript" [ref=e64] [cursor=pointer]:
      - /url: https://developer.mozilla.org/en-US/docs/Web/JavaScript
    - text: ·
    - link "📚 Showcase" [ref=e65] [cursor=pointer]:
      - /url: "?showcase=true"
```
