...
- Name: fs.spec.ts >> fs >> 8: fs.append_text extends a file
- Location: tests/e2e/fs.spec.ts:178:3
      ...
      - generic [ref=e41]:
        ...
        - generic [ref=e44]:
          - generic [ref=e46]:
            ...
            - generic [ref=e50]: "4"
          - textbox [ref=e53]:
            - generic [ref=e54]: await fs.write_text("/append.txt", "hello");
            - generic [ref=e55]: await fs.append_text("/append.txt", " world");
            - generic [ref=e56]: const txt = await fs.read_text("/append.txt");
            - generic [ref=e57]: "print(\"appended: \" + txt);"
      - generic [ref=e59]: "Internal error: No pending async command to resume"
  - contentinfo [ref=e60]:
    - text: Powered by
    - link "boa" [ref=e61] [cursor=pointer]:
      - /url: https://github.com/boa-dev/boa
    - text: ·
    - link "JavaScript" [ref=e62] [cursor=pointer]:
      - /url: https://developer.mozilla.org/en-US/docs/Web/JavaScript
    - text: ·
    - link "📚 Showcase" [ref=e63] [cursor=pointer]:
      - /url: "?showcase=true"
```
