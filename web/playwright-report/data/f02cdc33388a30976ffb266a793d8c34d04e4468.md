...
- Name: page-interactions.spec.ts >> page interactions >> 8: page.scroll_to on tall element succeeds
- Location: tests/e2e/page-interactions.spec.ts:202:3
          ...
          - generic [ref=e44]:
            - generic [ref=e45]:
              ...
              - generic [ref=e60]:
                ...
                - generic [ref=e64]: ⌄
            - textbox [ref=e66]:
              - generic [ref=e67]: const snap = await page.snapshot_data();
              - generic [ref=e68]: let tallRef = null;
              - generic [ref=e69]: "for (const node of snap.data.nodes) {"
              - generic [ref=e70]: "if (node.tag === \"div\" && node.refId) {"
              - generic [ref=e71]: tallRef = node.refId;
              - generic [ref=e72]: "}"
              - generic [ref=e73]: "}"
              - generic [ref=e74]: "if (tallRef) {"
              - generic [ref=e75]: await page.scroll_to(tallRef);
              - generic [ref=e76]: print("scrolled");
              - generic [ref=e77]: "} else {"
              - generic [ref=e78]: print("no tall element");
              - generic [ref=e79]: "}"
        - generic [ref=e81]: "Internal error: No pending async command to resume"
    - contentinfo [ref=e82]:
      - text: Powered by
      - link "boa" [ref=e83] [cursor=pointer]:
        - /url: https://github.com/boa-dev/boa
      - text: ·
      - link "JavaScript" [ref=e84] [cursor=pointer]:
        - /url: https://developer.mozilla.org/en-US/docs/Web/JavaScript
      - text: ·
      - link "📚 Showcase" [ref=e85] [cursor=pointer]:
        - /url: "?showcase=true"
  - generic [ref=e86]:
    - textbox [ref=e87]: initial
    - combobox [ref=e88]:
