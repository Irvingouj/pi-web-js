...
- Name: page-interactions.spec.ts >> page interactions >> 11: page.append on input appends text
- Location: tests/e2e/page-interactions.spec.ts:259:3
          ...
          - generic [ref=e44]:
            - generic [ref=e45]:
              ...
              - generic [ref=e62]:
                ...
                - generic [ref=e66]: ⌄
            - textbox [ref=e68]:
              - generic [ref=e69]: const snap = await page.snapshot_data();
              - generic [ref=e70]: let inputRef = null;
              - generic [ref=e71]: "for (const node of snap.data.nodes) {"
              - generic [ref=e72]: "if (node.tag === \"input\" && node.role === \"textbox\") {"
              - generic [ref=e73]: inputRef = node.refId;
              - generic [ref=e74]: break;
              - generic [ref=e75]: "}"
              - generic [ref=e76]: "}"
              - generic [ref=e77]: "if (inputRef) {"
              - generic [ref=e78]: await page.fill(inputRef, "hello");
              - generic [ref=e79]: await page.append(inputRef, " world");
              - generic [ref=e80]: print("appended");
              - generic [ref=e81]: "} else {"
              - generic [ref=e82]: print("no input");
              - generic [ref=e83]: "}"
        - generic [ref=e85]: "Internal error: No pending async command to resume"
    - contentinfo [ref=e86]:
      - text: Powered by
      ...
      - link "📚 Showcase" [ref=e89] [cursor=pointer]:
        - /url: "?showcase=true"
  - generic [ref=e90]:
    - textbox [ref=e91]: hello
    - combobox [ref=e92]:
      - option "Option A" [selected]
      - option "Option B"
    - checkbox [ref=e93]
    - button "Click me" [ref=e94]
```
