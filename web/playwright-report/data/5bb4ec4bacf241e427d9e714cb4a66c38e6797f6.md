...
- Name: fs.spec.ts >> fs >> 5: fs.exists and fs.delete
- Location: tests/e2e/fs.spec.ts:119:3
      ...
      - generic [ref=e41]:
        ...
        - generic [ref=e44]:
          - generic [ref=e46]:
            ...
            - generic [ref=e52]: "6"
          - textbox [ref=e55]:
            - generic [ref=e56]: await fs.write_text("/to_delete.txt", "temporary");
            - generic [ref=e57]: const before = await fs.exists("/to_delete.txt");
            - generic [ref=e58]: "print(\"before: \" + before);"
            - generic [ref=e59]: await fs.delete("/to_delete.txt");
            - generic [ref=e60]: const after = await fs.exists("/to_delete.txt");
