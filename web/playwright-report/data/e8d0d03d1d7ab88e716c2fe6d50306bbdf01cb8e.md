...
- Name: chrome-tabs.spec.ts >> web.tab content-script APIs >> web.tab.snapshot returns DOM snapshot from target tab
- Location: tests/e2e/chrome-tabs.spec.ts:237:3
