...
- Name: page-interactions.spec.ts >> page interactions >> 3: page.fill on input succeeds
- Location: tests/e2e/page-interactions.spec.ts:81:3
        ...
        - generic [ref=e41]:
          ...
          - generic [ref=e44]:
            ...
            - textbox [ref=e67]:
              ...
              - generic [ref=e69]: let inputRef = null;
              - generic [ref=e70]: "for (const node of snap.data.nodes) {"
              - generic [ref=e71]: "if (node.tag === \"input\" && node.role === \"textbox\") {"
              - generic [ref=e72]: inputRef = node.refId;
              - generic [ref=e73]: break;
              - generic [ref=e74]: "}"
              - generic [ref=e75]: "}"
              - generic [ref=e76]: "if (inputRef) {"
              - generic [ref=e77]: await page.fill(inputRef, "hello world");
              - generic [ref=e78]: print("filled");
              - generic [ref=e79]: "} else {"
              - generic [ref=e80]: print("no input");
              - generic [ref=e81]: "}"
