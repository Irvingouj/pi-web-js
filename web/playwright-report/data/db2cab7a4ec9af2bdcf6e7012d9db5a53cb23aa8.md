...
- Name: fs.spec.ts >> fs >> 3: fs.stat returns metadata
- Location: tests/e2e/fs.spec.ts:71:3
        ...
        - generic [ref=e44]:
          - generic [ref=e45]:
            ...
            - generic [ref=e64]:
              ...
              - generic [ref=e68]: ⌄
          - textbox [ref=e70]:
            - generic [ref=e71]: await fs.write_text("/stat_check.txt", "12345");
            - generic [ref=e72]: let ok = true;
            - generic [ref=e73]: let meta;
            - generic [ref=e74]: "try {"
            - generic [ref=e75]: meta = await fs.stat("/stat_check.txt");
            - generic [ref=e76]: "} catch (e) {"
            - generic [ref=e77]: ok = false;
            - generic [ref=e78]: meta = e;
            - generic [ref=e79]: "}"
            - generic [ref=e80]: "print(\"ok: \" + ok);"
            - generic [ref=e81]: "if (typeof meta === \"object\" && meta !== null) {"
            - generic [ref=e82]: "print(\"name: \" + meta.name);"
            - generic [ref=e83]: "print(\"kind: \" + meta.kind);"
            - generic [ref=e84]: "print(\"size: \" + meta.size);"
            - generic [ref=e85]: "} else {"
            - generic [ref=e86]: "print(\"meta: \" + meta);"
            - generic [ref=e87]: "}"
      - generic [ref=e89]: "Internal error: No pending async command to resume"
  - contentinfo [ref=e90]:
    - text: Powered by
    - link "boa" [ref=e91] [cursor=pointer]:
      - /url: https://github.com/boa-dev/boa
    - text: ·
    - link "JavaScript" [ref=e92] [cursor=pointer]:
      - /url: https://developer.mozilla.org/en-US/docs/Web/JavaScript
    - text: ·
    - link "📚 Showcase" [ref=e93] [cursor=pointer]:
      - /url: "?showcase=true"
```
