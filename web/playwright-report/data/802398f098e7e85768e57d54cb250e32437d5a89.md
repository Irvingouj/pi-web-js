...
- Name: page-agent.spec.ts >> page.agent >> 28: sidepanel.hover and sidepanel.unhover work
- Location: tests/e2e/page-agent.spec.ts:472:3
          ...
          - generic [ref=e44]:
            - generic [ref=e45]:
              ...
              - generic [ref=e63]:
                ...
                - generic [ref=e67]: ⌄
            - textbox [ref=e69]:
              - generic [ref=e70]: "const snap = await sidepanel.snapshot_data({ interactive_only: true });"
              - generic [ref=e71]: let btnRef = null;
              - generic [ref=e72]: "for (const node of snap.data.nodes) {"
              - generic [ref=e73]: "if (node.role === \"button\") {"
              - generic [ref=e74]: btnRef = node.refId;
              - generic [ref=e75]: break;
              - generic [ref=e76]: "}"
              - generic [ref=e77]: "}"
              - generic [ref=e78]: "if (btnRef) {"
              - generic [ref=e79]: const ok1 = await sidepanel.hover(btnRef);
              - generic [ref=e80]: print("hover:" + ok1);
              - generic [ref=e81]: const ok2 = await sidepanel.unhover();
              - generic [ref=e82]: print("unhover:" + ok2);
              - generic [ref=e83]: "} else {"
              - generic [ref=e84]: print("no button");
              - generic [ref=e85]: "}"
        - generic [ref=e87]: "Internal error: No pending async command to resume"
    - contentinfo [ref=e88]:
      - text: Powered by
      - link "boa" [ref=e89] [cursor=pointer]:
        - /url: https://github.com/boa-dev/boa
      - text: ·
      - link "JavaScript" [ref=e90] [cursor=pointer]:
        - /url: https://developer.mozilla.org/en-US/docs/Web/JavaScript
      - text: ·
      - link "📚 Showcase" [ref=e91] [cursor=pointer]:
        - /url: "?showcase=true"
  - generic [ref=e92]:
    - textbox [ref=e93]: initial
    - combobox [ref=e94]:
      - option "Option A" [selected]
      - option "Option B"
    - checkbox [ref=e95]
    - button "Click me" [ref=e96]
```
