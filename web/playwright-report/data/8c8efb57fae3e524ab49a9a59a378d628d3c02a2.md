...
- Name: page-agent.spec.ts >> page.agent >> 30: sidepanel.scroll_to on tall element succeeds
- Location: tests/e2e/page-agent.spec.ts:510:3
          ...
          - generic [ref=e44]:
            - generic [ref=e45]:
              ...
              - generic [ref=e60]:
                ...
                - generic [ref=e64]: ⌄
            - textbox [ref=e66]:
              - generic [ref=e67]: const snap = await sidepanel.snapshot_data();
              ...
              - generic [ref=e75]: await sidepanel.scroll_to(tallRef);
