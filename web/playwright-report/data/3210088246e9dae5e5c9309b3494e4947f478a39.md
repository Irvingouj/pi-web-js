...
- Name: fs.spec.ts >> fs >> 6: fs.copy and fs.move
- Location: tests/e2e/fs.spec.ts:136:3
      ...
      - generic [ref=e41]:
        ...
        - generic [ref=e44]:
          - generic [ref=e46]:
            ...
            - generic [ref=e56]: "10"
          - textbox [ref=e59]:
            - generic [ref=e60]: await fs.write_text("/copy_src.txt", "copyme");
            - generic [ref=e61]: await fs.copy("/copy_src.txt", "/copy_dst.txt");
            - generic [ref=e62]: const copied = await fs.read_text("/copy_dst.txt");
            - generic [ref=e63]: "print(\"copied: \" + copied);"
            - generic [ref=e64]: await fs.write_text("/move_src.txt", "moveme");
            - generic [ref=e65]: await fs.move("/move_src.txt", "/move_dst.txt");
            - generic [ref=e66]: const moved = await fs.read_text("/move_dst.txt");
            - generic [ref=e67]: "print(\"moved: \" + moved);"
            - generic [ref=e68]: const srcExists = await fs.exists("/move_src.txt");
            - generic [ref=e69]: "print(\"src_exists: \" + srcExists);"
      - generic [ref=e71]: "Internal error: No pending async command to resume"
  - contentinfo [ref=e72]:
    - text: Powered by
