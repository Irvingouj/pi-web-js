...
- Name: page-interactions.spec.ts >> page interactions >> 13: page.fill with CSS selector succeeds
- Location: tests/e2e/page-interactions.spec.ts:296:3
        ...
        - generic [ref=e41]:
          ...
          - generic [ref=e44]:
            - generic [ref=e46]:
              ...
              - generic [ref=e48]: "2"
            - textbox [ref=e51]:
              - generic [ref=e52]: await page.fill("#e2e-input", "hello");
              - generic [ref=e53]: print("filled");
        - generic [ref=e55]: "Internal error: No pending async command to resume"
    - contentinfo [ref=e56]:
      - text: Powered by
      - link "boa" [ref=e57] [cursor=pointer]:
        - /url: https://github.com/boa-dev/boa
      - text: ·
      - link "JavaScript" [ref=e58] [cursor=pointer]:
        - /url: https://developer.mozilla.org/en-US/docs/Web/JavaScript
      - text: ·
      - link "📚 Showcase" [ref=e59] [cursor=pointer]:
        - /url: "?showcase=true"
  - generic [ref=e60]:
    - textbox [ref=e61]: initial
    - combobox [ref=e62]:
      - option "Option A" [selected]
      - option "Option B"
    - checkbox [ref=e63]
    - button "Click me" [ref=e64]
```
