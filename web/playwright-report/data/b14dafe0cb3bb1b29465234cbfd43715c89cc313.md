...
- Name: page-interactions.spec.ts >> page interactions >> 12: page.click with CSS selector succeeds
- Location: tests/e2e/page-interactions.spec.ts:284:3
        ...
        - generic [ref=e41]:
          ...
          - generic [ref=e44]:
            - generic [ref=e46]:
              ...
              - generic [ref=e48]: "2"
            - textbox [ref=e51]:
              - generic [ref=e52]: await page.click("#e2e-button");
              - generic [ref=e53]: print("clicked");
