...
- Name: chrome-action-windows.spec.ts >> chrome.windows >> chrome.windows.create then chrome.windows.remove
- Location: tests/e2e/chrome-action-windows.spec.ts:70:3
