...
- Name: page-agent.spec.ts >> page.agent >> 7: page.hover and page.unhover work
- Location: tests/e2e/page-agent.spec.ts:113:3
          ...
          - generic [ref=e44]:
            - generic [ref=e45]:
              ...
              - generic [ref=e63]:
                ...
                - generic [ref=e67]: ⌄
            - textbox [ref=e69]:
              - generic [ref=e70]: "const snap = await page.snapshot_data({ interactive_only: true });"
              ...
              - generic [ref=e79]: const ok1 = await page.hover(btnRef);
              - generic [ref=e80]: print("hover:" + ok1);
              - generic [ref=e81]: const ok2 = await page.unhover();
