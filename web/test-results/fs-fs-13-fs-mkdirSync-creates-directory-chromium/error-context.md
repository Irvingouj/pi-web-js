...
- Name: fs.spec.ts >> fs >> 13: fs.mkdirSync creates directory
- Location: tests/e2e/fs.spec.ts:285:3
      ...
      - generic [ref=e41]:
        ...
        - generic [ref=e44]:
          - generic [ref=e46]:
            ...
            - generic [ref=e49]: "3"
          - textbox [ref=e52]:
            - generic [ref=e53]: fs.mkdirSync("/mkdirSync_dir");
            - generic [ref=e54]: const exists = fs.existsSync("/mkdirSync_dir");
            - generic [ref=e55]: "print(\"exists: \" + exists);"
      - generic [ref=e56]:
        - generic [ref=e57]: "[makeAsync] calling __webJsTriggerAsync for action: fs_mkdir"
        - generic [ref=e58]: "[makeAsync] __webJsTriggerAsync returned for action: fs_mkdir"
        - generic [ref=e59]: "[makeAsync] calling __webJsTriggerAsync for action: fs_exists"
        - generic [ref=e60]: "[makeAsync] __webJsTriggerAsync returned for action: fs_exists"
        - generic [ref=e61]: "exists: [object Promise]"
        - generic [ref=e62]: "[run_cell] pending_async_command: Some(AsyncCommand { call_id: 2, action: FsExists, params: Object {&quot;path&quot;: String(&quot;/mkdirSync_dir&quot;)} })"
        - generic [ref=e63]: "[resume_cell] pending_async_command: Some(AsyncCommand { call_id: 2, action: FsExists, params: Object {&quot;path&quot;: String(&quot;/mkdirSync_dir&quot;)} }), call_id: Some(2)"
  - contentinfo [ref=e64]:
    - text: Powered by
    - link "boa" [ref=e65] [cursor=pointer]:
      - /url: https://github.com/boa-dev/boa
    - text: ·
    - link "JavaScript" [ref=e66] [cursor=pointer]:
      - /url: https://developer.mozilla.org/en-US/docs/Web/JavaScript
    - text: ·
    - link "📚 Showcase" [ref=e67] [cursor=pointer]:
      - /url: "?showcase=true"
```
