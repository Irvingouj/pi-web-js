...
- Name: notebook.spec.ts >> JS Notebook >> 7: restart kernel clears state
- Location: tests/e2e/notebook.spec.ts:114:3
    ...
    - generic [ref=e27]:
      ...
      - generic [ref=e41]:
        ...
        - generic [ref=e44]:
          - generic [ref=e47]: "1"
          - textbox [ref=e50]:
            - generic [ref=e51]: print(x)
      - generic [ref=e52]:
        - generic [ref=e53]: "[run_cell] pending_async_command: None"
        - generic [ref=e54]: "{}"
  - contentinfo [ref=e55]:
    - text: Powered by
    - link "boa" [ref=e56] [cursor=pointer]:
      - /url: https://github.com/boa-dev/boa
    - text: ·
    - link "JavaScript" [ref=e57] [cursor=pointer]:
      - /url: https://developer.mozilla.org/en-US/docs/Web/JavaScript
    - text: ·
    - link "📚 Showcase" [ref=e58] [cursor=pointer]:
      - /url: "?showcase=true"
```
