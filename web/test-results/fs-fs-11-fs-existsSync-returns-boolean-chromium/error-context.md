...
- Name: fs.spec.ts >> fs >> 11: fs.existsSync returns boolean
- Location: tests/e2e/fs.spec.ts:236:3
      ...
      - generic [ref=e41]:
        ...
        - generic [ref=e44]:
          - generic [ref=e46]:
            ...
            - generic [ref=e51]: "5"
          - textbox [ref=e54]:
            - generic [ref=e55]: await fs.writeFile("/existsSync_test.txt", "x");
            - generic [ref=e56]: const before = fs.existsSync("/existsSync_test.txt");
            - generic [ref=e57]: const after = fs.existsSync("/existsSync_missing.txt");
            - generic [ref=e58]: "print(\"before: \" + before);"
            - generic [ref=e59]: "print(\"after: \" + after);"
      - generic [ref=e60]:
        - generic [ref=e61]: "[makeAsync] calling __webJsTriggerAsync for action: fs_write_text"
        - generic [ref=e62]: "[makeAsync] __webJsTriggerAsync returned for action: fs_write_text"
        - generic [ref=e63]: "[run_cell] pending_async_command: Some(AsyncCommand { call_id: 1, action: FsWriteText, params: Object {&quot;data&quot;: String(&quot;x&quot;), &quot;path&quot;: String(&quot;/existsSync_test.txt&quot;)} })"
        - generic [ref=e64]: "[resume_cell] pending_async_command: Some(AsyncCommand { call_id: 1, action: FsWriteText, params: Object {&quot;data&quot;: String(&quot;x&quot;), &quot;path&quot;: String(&quot;/existsSync_test.txt&quot;)} }), call_id: Some(1)"
        - generic [ref=e65]: "[makeAsync] calling __webJsTriggerAsync for action: fs_exists"
        - generic [ref=e66]: "[makeAsync] __webJsTriggerAsync returned for action: fs_exists"
        ...
        - generic [ref=e69]: "before: [object Promise]"
        - generic [ref=e70]: "after: [object Promise]"
        - generic [ref=e71]: "[resume_cell] pending_async_command: Some(AsyncCommand { call_id: 3, action: FsExists, params: Object {&quot;path&quot;: String(&quot;/existsSync_missing.txt&quot;)} }), call_id: Some(3)"
  - contentinfo [ref=e72]:
    - text: Powered by
    - link "boa" [ref=e73] [cursor=pointer]:
