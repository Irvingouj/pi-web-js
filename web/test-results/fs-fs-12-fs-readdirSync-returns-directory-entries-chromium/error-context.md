...
- Name: fs.spec.ts >> fs >> 12: fs.readdirSync returns directory entries
- Location: tests/e2e/fs.spec.ts:252:3
        ...
        - generic [ref=e44]:
          - generic [ref=e45]:
            ...
            - generic [ref=e67]:
              ...
              - generic [ref=e72]: ⌄
          - textbox [ref=e74]:
            - generic [ref=e75]: fs.mkdirSync("/readdirSync_dir");
            - generic [ref=e76]: await fs.writeFile("/readdirSync_dir/a.txt", "a");
            - generic [ref=e77]: await fs.writeFile("/readdirSync_dir/b.txt", "b");
            - generic [ref=e78]: let ok = true;
            - generic [ref=e79]: let entries;
            - generic [ref=e80]: "try {"
            - generic [ref=e81]: entries = fs.readdirSync("/readdirSync_dir");
            ...
            - generic [ref=e90]: "print(\"name: \" + e);"
            - generic [ref=e91]: "}"
            - generic [ref=e92]: "} else {"
            - generic [ref=e93]: "print(\"entries: \" + entries);"
            - generic [ref=e94]: "}"
      - generic [ref=e95]:
        - generic [ref=e96]: "[makeAsync] calling __webJsTriggerAsync for action: fs_mkdir"
        - generic [ref=e97]: "[makeAsync] __webJsTriggerAsync returned for action: fs_mkdir"
        - generic [ref=e98]: "[makeAsync] calling __webJsTriggerAsync for action: fs_write_text"
        - generic [ref=e99]: "[makeAsync] __webJsTriggerAsync returned for action: fs_write_text"
        - generic [ref=e100]: "[run_cell] pending_async_command: Some(AsyncCommand { call_id: 2, action: FsWriteText, params: Object {&quot;data&quot;: String(&quot;a&quot;), &quot;path&quot;: String(&quot;/readdirSync_dir/a.txt&quot;)} })"
        - generic [ref=e101]: "[resume_cell] pending_async_command: Some(AsyncCommand { call_id: 2, action: FsWriteText, params: Object {&quot;data&quot;: String(&quot;a&quot;), &quot;path&quot;: String(&quot;/readdirSync_dir/a.txt&quot;)} }), call_id: Some(2)"
        - generic [ref=e102]: "[makeAsync] calling __webJsTriggerAsync for action: fs_write_text"
        - generic [ref=e103]: "[makeAsync] __webJsTriggerAsync returned for action: fs_write_text"
        - generic [ref=e104]: "[resume_cell] pending_async_command: Some(AsyncCommand { call_id: 3, action: FsWriteText, params: Object {&quot;data&quot;: String(&quot;b&quot;), &quot;path&quot;: String(&quot;/readdirSync_dir/b.txt&quot;)} }), call_id: Some(3)"
        - generic [ref=e105]: "[makeAsync] calling __webJsTriggerAsync for action: fs_list"
        - generic [ref=e106]: "[makeAsync] __webJsTriggerAsync returned for action: fs_list"
        - generic [ref=e107]: "ok: true"
        - generic [ref=e108]: "entries: [object Promise]"
        - generic [ref=e109]: "[resume_cell] pending_async_command: Some(AsyncCommand { call_id: 4, action: FsList, params: Object {&quot;path&quot;: String(&quot;/readdirSync_dir&quot;)} }), call_id: Some(4)"
  - contentinfo [ref=e110]:
    - text: Powered by
    - link "boa" [ref=e111] [cursor=pointer]:
      - /url: https://github.com/boa-dev/boa
    - text: ·
    - link "JavaScript" [ref=e112] [cursor=pointer]:
      - /url: https://developer.mozilla.org/en-US/docs/Web/JavaScript
    - text: ·
    - link "📚 Showcase" [ref=e113] [cursor=pointer]:
      - /url: "?showcase=true"
```
