...
- Name: fs.spec.ts >> fs >> 10: fs.writeFile writes text
- Location: tests/e2e/fs.spec.ts:214:3
  ...
  - main [ref=e25]:
    - generic [ref=e27]:
        ...
        - generic [ref=e44]:
          - generic [ref=e45]:
            ...
            - generic [ref=e58]:
              ...
              - generic [ref=e60]: ⌄
          - textbox [ref=e62]:
            - generic [ref=e63]: fs.writeFile("/writeFile_test.txt", "writeFile data");
            - generic [ref=e64]: let ok = true;
            - generic [ref=e65]: let txt;
            - generic [ref=e66]: "try {"
            - generic [ref=e67]: txt = fs.readFile("/writeFile_test.txt", "utf8");
      ...
      - generic [ref=e74]:
        ...
        - generic [ref=e77]: "[makeAsync] calling __webJsTriggerAsync for action: fs_read_text"
        - generic [ref=e78]: "[makeAsync] __webJsTriggerAsync returned for action: fs_read_text"
        - generic [ref=e79]: "ok: true"
        - generic [ref=e80]: "txt: [object Promise]"
        - generic [ref=e81]: "[run_cell] pending_async_command: Some(AsyncCommand { call_id: 2, action: FsReadText, params: Object {&quot;path&quot;: String(&quot;/writeFile_test.txt&quot;)} })"
        - generic [ref=e82]: "[resume_cell] pending_async_command: Some(AsyncCommand { call_id: 2, action: FsReadText, params: Object {&quot;path&quot;: String(&quot;/writeFile_test.txt&quot;)} }), call_id: Some(2)"
  - contentinfo [ref=e83]:
    - text: Powered by
    - link "boa" [ref=e84] [cursor=pointer]:
      - /url: https://github.com/boa-dev/boa
    - text: ·
    - link "JavaScript" [ref=e85] [cursor=pointer]:
      - /url: https://developer.mozilla.org/en-US/docs/Web/JavaScript
    - text: ·
    - link "📚 Showcase" [ref=e86] [cursor=pointer]:
      - /url: "?showcase=true"
```
