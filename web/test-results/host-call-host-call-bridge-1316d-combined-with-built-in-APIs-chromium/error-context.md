...
- Name: host-call.spec.ts >> host.call() bridge >> 5: host.call combined with built-in APIs
- Location: tests/e2e/host-call.spec.ts:126:3
  ...
  - main [ref=e25]:
    - generic [ref=e27]:
      ...
      - generic [ref=e41]:
        ...
        - generic [ref=e44]:
          ...
          - textbox [ref=e66]:
            ...
            - generic [ref=e69]: "try {"
            - generic [ref=e70]: "result = await host.call(\"echo\", { msg: \"hello\" });"
            - generic [ref=e71]: "} catch (e) {"
            - generic [ref=e72]: ok = false;
            - generic [ref=e73]: result = e;
            - generic [ref=e74]: "}"
            - generic [ref=e75]: "if (ok) {"
            - generic [ref=e76]: "print(\"Type: \" + typeof result);"
      ...
      - generic [ref=e80]:
        ...
        - generic [ref=e83]: "[run_cell] pending_async_command: Some(AsyncCommand { call_id: 1, action: Host(&quot;call&quot;), params: Object {&quot;action&quot;: String(&quot;echo&quot;), &quot;params&quot;: Object {&quot;msg&quot;: String(&quot;hello&quot;)}} })"
        - generic [ref=e84]: "[resume_cell] pending_async_command: Some(AsyncCommand { call_id: 1, action: Host(&quot;call&quot;), params: Object {&quot;action&quot;: String(&quot;echo&quot;), &quot;params&quot;: Object {&quot;msg&quot;: String(&quot;hello&quot;)}} }), call_id: Some(1)"
