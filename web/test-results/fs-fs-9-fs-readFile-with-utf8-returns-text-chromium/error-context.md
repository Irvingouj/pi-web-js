...
- Name: fs.spec.ts >> fs >> 9: fs.readFile with utf8 returns text
- Location: tests/e2e/fs.spec.ts:192:3
        ...
        - generic [ref=e44]:
          - generic [ref=e45]:
            ...
            - generic [ref=e58]:
              ...
              - generic [ref=e60]: ⌄
          - textbox [ref=e62]:
            - generic [ref=e63]: await fs.writeFile("/readFile_test.txt", "readFile hello");
            - generic [ref=e64]: let ok = true;
            - generic [ref=e65]: let txt;
            - generic [ref=e66]: "try {"
            - generic [ref=e67]: txt = fs.readFile("/readFile_test.txt", "utf8");
            - generic [ref=e68]: "} catch (e) {"
            - generic [ref=e69]: ok = false;
            - generic [ref=e70]: txt = e;
            - generic [ref=e71]: "}"
            - generic [ref=e72]: "print(\"ok: \" + ok);"
            - generic [ref=e73]: "print(\"txt: \" + txt);"
      - generic [ref=e74]:
        - generic [ref=e75]: "[makeAsync] calling __webJsTriggerAsync for action: fs_write_text"
        - generic [ref=e76]: "[makeAsync] __webJsTriggerAsync returned for action: fs_write_text"
        - generic [ref=e77]: "[run_cell] pending_async_command: Some(AsyncCommand { call_id: 1, action: FsWriteText, params: Object {&quot;data&quot;: String(&quot;readFile hello&quot;), &quot;path&quot;: String(&quot;/readFile_test.txt&quot;)} })"
        - generic [ref=e78]: "[resume_cell] pending_async_command: Some(AsyncCommand { call_id: 1, action: FsWriteText, params: Object {&quot;data&quot;: String(&quot;readFile hello&quot;), &quot;path&quot;: String(&quot;/readFile_test.txt&quot;)} }), call_id: Some(1)"
        - generic [ref=e79]: "[makeAsync] calling __webJsTriggerAsync for action: fs_read_text"
        - generic [ref=e80]: "[makeAsync] __webJsTriggerAsync returned for action: fs_read_text"
        - generic [ref=e81]: "ok: true"
        - generic [ref=e82]: "txt: [object Promise]"
        - generic [ref=e83]: "[resume_cell] pending_async_command: Some(AsyncCommand { call_id: 2, action: FsReadText, params: Object {&quot;path&quot;: String(&quot;/readFile_test.txt&quot;)} }), call_id: Some(2)"
  - contentinfo [ref=e84]:
    - text: Powered by
    - link "boa" [ref=e85] [cursor=pointer]:
      - /url: https://github.com/boa-dev/boa
    - text: ·
    - link "JavaScript" [ref=e86] [cursor=pointer]:
      - /url: https://developer.mozilla.org/en-US/docs/Web/JavaScript
    - text: ·
    - link "📚 Showcase" [ref=e87] [cursor=pointer]:
      - /url: "?showcase=true"
```
