...
- Name: fs.spec.ts >> fs >> 14: fs.unlinkSync deletes file
- Location: tests/e2e/fs.spec.ts:298:3
      ...
      - generic [ref=e41]:
        ...
        - generic [ref=e44]:
          - generic [ref=e46]:
            ...
            - generic [ref=e52]: "6"
          - textbox [ref=e55]:
            - generic [ref=e56]: await fs.writeFile("/unlinkSync_test.txt", "delete me");
            - generic [ref=e57]: const before = fs.existsSync("/unlinkSync_test.txt");
            - generic [ref=e58]: fs.unlinkSync("/unlinkSync_test.txt");
            - generic [ref=e59]: const after = fs.existsSync("/unlinkSync_test.txt");
            - generic [ref=e60]: "print(\"before: \" + before);"
            - generic [ref=e61]: "print(\"after: \" + after);"
      - generic [ref=e62]:
        - generic [ref=e63]: "[makeAsync] calling __webJsTriggerAsync for action: fs_write_text"
        - generic [ref=e64]: "[makeAsync] __webJsTriggerAsync returned for action: fs_write_text"
        - generic [ref=e65]: "[run_cell] pending_async_command: Some(AsyncCommand { call_id: 1, action: FsWriteText, params: Object {&quot;data&quot;: String(&quot;delete me&quot;), &quot;path&quot;: String(&quot;/unlinkSync_test.txt&quot;)} })"
        - generic [ref=e66]: "[resume_cell] pending_async_command: Some(AsyncCommand { call_id: 1, action: FsWriteText, params: Object {&quot;data&quot;: String(&quot;delete me&quot;), &quot;path&quot;: String(&quot;/unlinkSync_test.txt&quot;)} }), call_id: Some(1)"
        - generic [ref=e67]: "[makeAsync] calling __webJsTriggerAsync for action: fs_exists"
        - generic [ref=e68]: "[makeAsync] __webJsTriggerAsync returned for action: fs_exists"
        - generic [ref=e69]: "[makeAsync] calling __webJsTriggerAsync for action: fs_delete"
        - generic [ref=e70]: "[makeAsync] __webJsTriggerAsync returned for action: fs_delete"
        - generic [ref=e71]: "[makeAsync] calling __webJsTriggerAsync for action: fs_exists"
        - generic [ref=e72]: "[makeAsync] __webJsTriggerAsync returned for action: fs_exists"
        - generic [ref=e73]: "before: [object Promise]"
        - generic [ref=e74]: "after: [object Promise]"
        - generic [ref=e75]: "[resume_cell] pending_async_command: Some(AsyncCommand { call_id: 4, action: FsExists, params: Object {&quot;path&quot;: String(&quot;/unlinkSync_test.txt&quot;)} }), call_id: Some(4)"
  - contentinfo [ref=e76]:
    - text: Powered by
    - link "boa" [ref=e77] [cursor=pointer]:
      - /url: https://github.com/boa-dev/boa
    - text: ·
    - link "JavaScript" [ref=e78] [cursor=pointer]:
      - /url: https://developer.mozilla.org/en-US/docs/Web/JavaScript
    - text: ·
    - link "📚 Showcase" [ref=e79] [cursor=pointer]:
      - /url: "?showcase=true"
```
