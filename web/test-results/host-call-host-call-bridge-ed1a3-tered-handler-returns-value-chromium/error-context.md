...
- Name: host-call.spec.ts >> host.call() bridge >> 2: host.call with registered handler returns value
- Location: tests/e2e/host-call.spec.ts:35:3
        ...
        - generic [ref=e44]:
          - generic [ref=e45]:
            ...
            - generic [ref=e60]:
              ...
              - generic [ref=e64]: ⌄
          - textbox [ref=e66]:
            - generic [ref=e67]: let ok = true;
            - generic [ref=e68]: let result;
            - generic [ref=e69]: "try {"
            - generic [ref=e70]: "result = await host.call(\"greet\", { name: \"JS\" });"
            - generic [ref=e71]: "} catch (e) {"
            - generic [ref=e72]: ok = false;
            - generic [ref=e73]: result = e;
            - generic [ref=e74]: "}"
            - generic [ref=e75]: "if (ok) {"
            - generic [ref=e76]: "print(\"Result: \" + result);"
            - generic [ref=e77]: "} else {"
            - generic [ref=e78]: "print(\"Error: \" + result);"
            - generic [ref=e79]: "}"
      - generic [ref=e80]:
        - generic [ref=e81]: "[makeAsync] calling __webJsTriggerAsync for action: host_call"
        - generic [ref=e82]: "[makeAsync] __webJsTriggerAsync returned for action: host_call"
        - generic [ref=e83]: "[run_cell] pending_async_command: Some(AsyncCommand { call_id: 1, action: Host(&quot;call&quot;), params: Object {&quot;action&quot;: String(&quot;greet&quot;), &quot;params&quot;: Object {&quot;name&quot;: String(&quot;JS&quot;)}} })"
        - generic [ref=e84]: "[resume_cell] pending_async_command: Some(AsyncCommand { call_id: 1, action: Host(&quot;call&quot;), params: Object {&quot;action&quot;: String(&quot;greet&quot;), &quot;params&quot;: Object {&quot;name&quot;: String(&quot;JS&quot;)}} }), call_id: Some(1)"
        - generic [ref=e85]: "Error: Error: No handler registered for 'call'"
  - contentinfo [ref=e86]:
    - text: Powered by
    - link "boa" [ref=e87] [cursor=pointer]:
      - /url: https://github.com/boa-dev/boa
    - text: ·
    - link "JavaScript" [ref=e88] [cursor=pointer]:
      - /url: https://developer.mozilla.org/en-US/docs/Web/JavaScript
    - text: ·
    - link "📚 Showcase" [ref=e89] [cursor=pointer]:
      - /url: "?showcase=true"
```
