...
(async () => {
  ...
  console.log('new Object():', JSON.stringify(t1));

  const t2 = await runCode('new Array()');
  console.log('new Array():', JSON.stringify(t2));

  const t3 = await runCode('new Date()');
  console.log('new Date():', JSON.stringify(t3));

  const t4 = await runCode('new String("hello")');
  console.log('new String():', JSON.stringify(t4));
