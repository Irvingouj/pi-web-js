...
(async () => {
  ...
  const t1 = await runCode('var e = new Error("boom"); e.message');
  console.log('new Error message:', JSON.stringify(t1));

  const t2 = await runCode('var e = new Error("boom"); e');
  console.log('new Error object:', JSON.stringify(t2));
